      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 md:px-8 py-6 border-b border-[#2d3142] shrink-0 gap-4">
        ...
        <div className="flex bg-[#1a1d29] p-1 rounded-lg border border-[#2d3142] w-full sm:w-auto">
          <button
            ...
            className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'REPORT' ? 'bg-[#2d3142] text-white shadow-sm' : 'text-gray-400 hover:text-gray-200'
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'LOG' ? 'bg-[#2d3142] text-white shadow-sm' : 'text-gray-400 hover:text-gray-200'
              }`}
          >
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  {[IncidentSeverity.LOW, IncidentSeverity.MEDIUM, IncidentSeverity.HIGH].map((lvl) => (
                    <button
                      ...
                      className={`flex-1 py-3 rounded-lg font-bold border transition-all ${severity === lvl
                            ...
                            <div className="grid grid-cols-3 gap-2">
                              {(['OPEN', 'INVESTIGATING', 'RESOLVED'] as const).map((statusOption) => (
                                <button
                                  ...
                                  className={`py-2 rounded text-[10px] font-bold border transition-all ${inc.status === statusOption
                                      ? getStatusColor(statusOption) + ' border-transparent ring-1 ring-white/20'
