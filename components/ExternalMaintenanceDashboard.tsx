...
const ExternalMaintenanceDashboard: React.FC<ExternalMaintenanceProps> = ({
    ...
    const attemptZoneUnlock = () => {
        ...
        const simulateProgress = setInterval(() => {
            setScanProgress(prev => {
                ...
                return prev + 25; // Sped up from 15
            });
        }, 80); // Sped up from 100
    };
    ...
    return (
        <div className="flex flex-col h-full bg-[#1a1d29] max-w-4xl mx-auto w-full">
            ...
            <div className="bg-yellow-400/10 border-b border-yellow-400/20 p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="p-2 bg-yellow-400/10 hover:bg-yellow-400/20 border border-yellow-400/20 rounded-lg transition-colors text-yellow-400"
            ...
            {/* Settings Sidepanel */}
            <div className={`fixed inset-y-0 right-0 z-[120] w-full max-w-sm bg-[#1a1d29] border-l border-gray-700 shadow-2xl transform transition-transform duration-300 ease-in-out ${isSettingsOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="h-full flex flex-col">
                    <div className="p-6 border-b border-gray-700 flex items-center justify-between bg-[#2d3142]">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-xl font-bold text-white">Vendor Settings</h2>
                        </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-8">
                        ...
                        <section>
                            ...
                            <div className="bg-black/20 rounded-xl p-4 border border-white/5 space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-yellow-400 text-sm font-bold">{CONST_WORK_ORDER.targetZone}</span>
                                </div>
                            </div>
                        </section>
                        ...
                        {/* Session Status */}
                        <section>
                            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">Session Monitoring</h3>
                            <div className="bg-black/20 rounded-xl p-4 border border-white/5 space-y-4">
                                <div>
                                    <div className="flex justify-between mb-1">
                                        ...
                                        <span className={`font-mono text-sm ${timeLeft < 300 ? 'text-red-500 font-bold' : 'text-white'}`}>{formatTime(timeLeft)}</span>
                                    </div>
                                    <div className="h-1 bg-gray-800 rounded-full overflow-hidden">
                                        <div
                                            className={`h-full transition-all duration-1000 ${timeLeft < 300 ? 'bg-red-500' : 'bg-yellow-400'}`}
                                            style={{ width: `${(timeLeft / (CONST_WORK_ORDER.timeLimitMinutes * 60)) * 100}%` }}
                                        />
                                    </div>
                                </div>
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-1">
                                    <span className="text-sm text-gray-300">Audible Alerts</span>
                                    <div className="w-10 h-5 bg-yellow-400 rounded-full flex items-center justify-end px-1 cursor-pointer">
                    ...
                    <div className="p-6 border-t border-gray-700 space-y-3 bg-[#2d3142]/50">
                        ...
                        <p className="text-[10px] text-gray-600 text-center uppercase tracking-widest font-mono">
                            System Node: AG-EXT-VW-01
                        </p>
                    </div>
                </div>
            </div>

            {/* Backdrop for sidepanel */}
            {isSettingsOpen && (
                <div
                    className="fixed inset-0 z-[115] bg-black/60 backdrop-blur-sm animate-fadeIn"
