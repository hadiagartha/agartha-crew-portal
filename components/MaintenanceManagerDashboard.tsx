...
const MaintenanceManagerDashboard: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-[#1a1d29]">
            {/* Header section with sticky header */}
            <div className="flex-none p-4 md:p-6 border-b border-[#2d3142] flex flex-wrap gap-4 md:gap-6 items-center justify-between bg-[#1a1d29]/80 backdrop-blur-md sticky top-0 z-20">
                <div>
                    <h2 className="text-xl md:text-2xl font-bold text-white flex items-center gap-3">
                        <Shield className="text-blue-500" size={28} /> Maintenance Command
                    </h2>
                    <p className="text-xs md:text-sm text-gray-400 mt-1">Strategic Oversight & Technical Triage</p>
                </div>
                <div className="bg-[#2d3142] px-4 py-2 rounded-xl border border-white/5 flex items-center gap-4 ml-auto">
                    <div className="flex flex-col">
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none">Active Tickets</span>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-6">
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-[#2d3142]/50 backdrop-blur-md p-4 md:p-6 rounded-2xl border border-white/5 flex flex-col min-h-[500px]">
                            <h3 className="text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2 mb-6">
                                <MapIcon size={16} className="text-blue-400" /> Global Health Map
                            </h3>

                            <div className="flex-1 relative flex items-center justify-center p-2 md:p-4 bg-black/20 rounded-xl overflow-hidden">
                                <svg viewBox="0 0 800 600" className="w-full h-auto max-h-[400px] md:max-h-[500px]">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-700/50">
                                <div className="flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-green-500/20 border border-green-500" />
                                    <span className="text-[10px] text-gray-400 capitalize">Green (Nominal)</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-yellow-500/20 border border-yellow-500" />
                                    <span className="text-[10px] text-gray-400 capitalize">Yellow (Warning)</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-red-500/20 border border-red-500" />
                                    <span className="text-[10px] text-gray-400 capitalize">Degraded (Critical)</span>
                                </div>
                            </div>
                        </div>

                        {/* Right: Active Service Tickets */}
                        <div className="bg-[#2d3142]/50 backdrop-blur-md p-4 md:p-6 rounded-2xl border border-white/5 flex flex-col h-fit lg:max-h-[700px]">
                            <h3 className="text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2 mb-6">
                                <Ticket size={16} className="text-yellow-400" /> Pending Tickets
                            </h3>
                    ...
                    <div className="bg-[#2d3142]/30 p-4 md:p-6 rounded-2xl border border-white/5">
                        <h3 className="text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2 mb-6">
