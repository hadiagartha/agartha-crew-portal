export enum View {
  ...
  EXPERIENCE_LOST_AND_FOUND = 'EXPERIENCE_LOST_AND_FOUND',

  // Health Crew Specific Views
  HEALTH_INCIDENT_LOG = 'HEALTH_INCIDENT_LOG',
  HEALTH_RESPONSE_TRACKER = 'HEALTH_RESPONSE_TRACKER',
  HEALTH_CONSUMABLES = 'HEALTH_CONSUMABLES',
  HEALTH_RESTOCK = 'HEALTH_RESTOCK',
  HEALTH_EQUIPMENT_AUDIT = 'HEALTH_EQUIPMENT_AUDIT',
...
export function defaultViewForMode(mode: AppMode): View {
  switch (mode) {
    ...
    case 'EXPERIENCE_CREW':
      return View.HOME;
    case 'CLEANING_CREW':
      return View.CLEANING_DAILY_CHECKLIST;
    case 'GIFTSHOP_CREW':
...
export function allowedViewsForMode(mode: AppMode): View[] {
  switch (mode) {
    ...
    case 'EXPERIENCE_CREW':
      return [View.HOME, View.ZONE_CHECK_IN, View.EXPERIENCE_LOST_AND_FOUND, View.SETTINGS, View.ANNOUNCEMENTS];
    case 'GIFTSHOP_CREW':
      return [
        View.HOME,
        View.ZONE_CHECK_IN,
